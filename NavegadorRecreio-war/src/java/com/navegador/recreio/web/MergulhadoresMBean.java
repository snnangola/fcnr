 ...
 * @author snnangolaPC
 */
@ManagedBean(name="mergulhadores")
//@ViewScoped
@SessionScoped
//@RequestScoped

public class MergulhadoresMBean implements java.io.Serializable{
    @EJB
    private NavegadorRecreioSessionBean navegadorRecreioSessionBean;
    //private NavegadorRecreio navegadorRecreio;
    private Mergulhadores mergulhadores;
    //private NavegadorRecreioPK navegadorRecreioPk;
    private MergulhadoresPK mergulhadoresPk;
    private TipoLicencaMergulhador tipoLicencaMergulhador;
    private TipoLicencaMergulhador categoriaLicencaMergulhador;
    ...
    private List<Mergulhadores> listaMergulhadorPorNIF;
    private List<Mergulhadores> listaMergulhadorPorBI;
    private List<Mergulhadores> listaMergulhadorPorNumeroLicenca;
     ...
     */
    public MergulhadoresMBean() {
       
        
        //navegadorRecreio = new NavegadorRecreio();
        mergulhadores = new Mergulhadores();
        //categoria = new Categoria(); 
        //categoriaPk = new CategoriaPK();
        //competencia = new Competencia();        
       // navegadorRecreioPk = new NavegadorRecreioPK();
        mergulhadoresPk = new MergulhadoresPK();
        
        tipoLicencaMergulhador = new TipoLicencaMergulhador();
        categoriaLicencaMergulhador = new TipoLicencaMergulhador();
  ...
  /*  
    ...
    */
     public MergulhadoresMBean(List<Mergulhadores> listaMergulhadorPorNIF,List<Mergulhadores> listaMergulhadorPorBI , List<Mergulhadores> listaMergulhadorPorNumeroLicenca) {
       
    
       
       this.listaMergulhadorPorNIF = listaMergulhadorPorNIF;
       this.listaMergulhadorPorBI = listaMergulhadorPorBI;
       this.listaMergulhadorPorNumeroLicenca = listaMergulhadorPorNumeroLicenca;
    }
    
    public Mergulhadores getMergulhadores() {
    ...
    */
    public List getListaMergulhadorPorNIF()
    {
    
        return listaMergulhadorPorNIF;
    }
    
    public List getListaMergulhadorPorBI()
    {
    
        return listaMergulhadorPorBI;
    }
    
    public List getListaMergulhadorPorNumeroLicenca()
    {
    
        return listaMergulhadorPorNumeroLicenca;
    }
    /*
    ...
    */
    ...
    /*
    public String inserirMergulhador(){
 ...
 //   navegadorRecreio = new NavegadorRecreio();    
    ...
    */
    ...
    //Persistir uma bean tipoLicencaMergulhador na base de dados
    public String inserirTipoLicencaMergulhador(){
    
    //competencia = new Competencia();
    //competencia = this.navegadorRecreio.getCategoria().getCompetencia();
    
    
        tipoLicencaMergulhador.setTipoLicencaMergulho(this.tipoLicencaMergulhador.getTipoLicencaMergulho());
    ...
    //Testar nullidade de beans categoria e competencia...
    if(tipoLicencaMergulhador!=null){
        //inserir Bean Categoria...
        
        navegadorRecreioSessionBean.adicionaTipoLicencaMergulhador(tipoLicencaMergulhador);
        System.out.println("Sucesso!!! Dados inseridos com sucesso na base de dados\n");
        navegadorRecreioSessionBean.showSucesso("SUCESSO NA OPERACAO");
        return "InserirTipoLicencaMergulhador?faces-redirect=true";
...
public List listarMergulhadores(){

    return navegadorRecreioSessionBean.listarTodosMergulhadores();

}



//Retorna a lista de Navegadores

public List listarTipoLicencaMergulhador(){

    return navegadorRecreioSessionBean.listarTodosTipoLicencaMergulhador();
...
public void listarMergulhadorPorNIFMergulhador()
{

listaMergulhadorPorNIF = navegadorRecreioSessionBean.mergulhadorPorListagemNIF(mergulhadores.getNifMergulhador().trim());
System.out.println(listaMergulhadorPorNIF.toString());



}

public void listarMergulhadorPorBIMergulhador()
{

listaMergulhadorPorBI = navegadorRecreioSessionBean.mergulhadorPorListagemBI(mergulhadores.getBiMergulhador().trim());
System.out.println(listaMergulhadorPorBI.toString());



}

public void listarMergulhadorPorNumeroLicenca()
{

  listaMergulhadorPorNumeroLicenca = navegadorRecreioSessionBean.mergulhadorPorListagemNumeroLicenca(mergulhadores.getNumeroLicencaMergulhador().trim());
  System.out.println(listaMergulhadorPorNumeroLicenca.toString());
}
