 ...
 * @author snnangolaPC
 */
@ManagedBean(name="associacoes")
//@ViewScoped
@SessionScoped
//@RequestScoped

public class AssociacoesMBean implements java.io.Serializable{
    @EJB
    ...
    private List<Associacoes> listaAssociacaoPorNIF;
    private List<Associacoes> listaAssociacaoPorNome;
  ...
  /*  
    ...
    */
     public AssociacoesMBean(List<Associacoes> listaAssociacaoPorNIF, List<Associacoes> listaAssociacaoPorNome) {
       
    
       
       this.listaAssociacaoPorNIF = listaAssociacaoPorNIF;
       this.listaAssociacaoPorNome = listaAssociacaoPorNome;
    }
    ...
    */
    public List getListaAssociacaoPorNIF()
    {
    
        return listaAssociacaoPorNIF;
    }
    
    public List getListaAssociacaoPorNome()
    {
    
        return listaAssociacaoPorNome;
    }
    /*
...
public List listarAssociacoes(){

    return navegadorRecreioSessionBean.listarTodosAssociacoes();
...
public void listarAssociacaoPorNIFAssociacao()
{

listaAssociacaoPorNIF = navegadorRecreioSessionBean.associacaoPorListagemNIF(associacoes.getNifAssociacao().trim());
System.out.println(listaAssociacaoPorNIF.toString());



}

public void listarAssociacaoPorNomeAssociacao()
{

  listaAssociacaoPorNome = navegadorRecreioSessionBean.associacaoPorListagemNome(associacoes.getNomeAssociacao().trim());
  System.out.println(listaAssociacaoPorNome.toString());
